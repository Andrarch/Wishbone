    ...
    class myNetworkUser {
        ...
        public function generateMyNetworkCell(){
            ...
            if ($this->getStatus()==2){
                ...
                echo "<h1>".$this->getUserFName()." ".$this->getUserLName()."</h1><p>";
                echo "<button class=msgBtn onclick=\"location.href='chat.php?receiverid=".$this->getUserID(). "' \" type=\"button\">Accept Request</button>";
                echo "</p> </a> </div> </li>";
            }
            if ($this->getStatus()==3){
                echo "<li class='hexRequest'>";
                echo " <div class='hexIn'>";
                echo "<a href=\"location.href='profile.php?id=".$this->getUserID(). "'\">";
                echo "<img class='myNet' src=\"https://farm8.staticflickr.com/7187/6895047173_d4b1a0d798.jpg\" alt=\"\" />";
                echo "<h1>".$this->getUserFName()." ".$this->getUserLName()."</h1><p>";
                echo "<button class=msgBtn onclick=\"location.href='chat.php?receiverid=".$this->getUserID(). "'\" type=\"button\">Cancel Request</button>";
                echo "</p> </a> </div> </li>";
            }
            if ($this->getStatus()==4){
                ...
                echo "<h1>".$this->getUserFName()." ".$this->getUserLName()."</h1><p>";
                echo "<button class=msgBtn onclick=\"location.href='chat.php?receiverid=".$this->getUserID(). "'\" type=\"button\">Invite to Network</button>";
                echo "</p> </a> </div> </li>";
            }
