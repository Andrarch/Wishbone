						...
						<div class="row">
							<div class="col-lg-10 offset-0 offset-sm-0 offset-md-0 offset-lg-1 ">
								...
								<div class="title-01 title-01__style-04" style="margin-bottom:25px;">
									<h2 class="title-01__title"><span>Log in with email</span></h2>
									<div class="row">
												...
												<div class="form-search">
													<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
														...
														<div class="form__button">
															<button class="btn btn-primary btn-w180" type="submit">Log in</button>
															<a class="btn btn-primary btn-w180" href="signup_user.php">Sign Up</a>
														</div>
													</form>
												</div><!-- End / form-search -->
											</div>
